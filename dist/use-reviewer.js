	...
	if (check) return ZodAny.create().superRefine((data, ctx) => {
		...
		if (r instanceof Promise) return r.then((r$1) => {
			...
			if (!r$1) {
				...
				const _fatal = (_b$1 = (_a$1 = params.fatal) !== null && _a$1 !== void 0 ? _a$1 : fatal) !== null && _b$1 !== void 0 ? _b$1 : true;
				ctx.addIssue({
					code: "custom",
					...params,
					fatal: _fatal
...
function tBlobs(apiClient, blobs) {
	if (Array.isArray(blobs)) return blobs.map((blob) => tBlob(apiClient, blob));
	else return [tBlob(apiClient, blobs)];
}
...
function flattenTypeArrayToAnyOf(typeList, resultingSchema) {
	...
	if (listWithoutNull.length === 1) resultingSchema["type"] = Object.keys(Type).includes(listWithoutNull[0].toUpperCase()) ? Type[listWithoutNull[0].toUpperCase()] : Type.TYPE_UNSPECIFIED;
	else {
		resultingSchema["anyOf"] = [];
		for (const i of listWithoutNull) resultingSchema["anyOf"].push({ "type": Object.keys(Type).includes(i.toUpperCase()) ? Type[i.toUpperCase()] : Type.TYPE_UNSPECIFIED });
	}
}
...
function tTool(apiClient, tool) {
	if (tool.functionDeclarations) for (const functionDeclaration of tool.functionDeclarations) {
		if (functionDeclaration.parameters) functionDeclaration.parameters = tSchema(apiClient, functionDeclaration.parameters);
		if (functionDeclaration.response) functionDeclaration.response = tSchema(apiClient, functionDeclaration.response);
	}
	return tool;
}
...
function videoMetadataToMldev$2(apiClient, fromObject) {
	...
	if (fromFps != null) setValueByPath(toObject, ["fps"], fromFps);
	const fromEndOffset = getValueByPath(fromObject, ["endOffset"]);
	if (fromEndOffset != null) setValueByPath(toObject, ["endOffset"], fromEndOffset);
	const fromStartOffset = getValueByPath(fromObject, ["startOffset"]);
	if (fromStartOffset != null) setValueByPath(toObject, ["startOffset"], fromStartOffset);
	return toObject;
}
...
function partToMldev$2(apiClient, fromObject) {
	...
	if (fromVideoMetadata != null) setValueByPath(toObject, ["videoMetadata"], videoMetadataToMldev$2(apiClient, fromVideoMetadata));
	const fromThought = getValueByPath(fromObject, ["thought"]);
	if (fromThought != null) setValueByPath(toObject, ["thought"], fromThought);
	const fromInlineData = getValueByPath(fromObject, ["inlineData"]);
	if (fromInlineData != null) setValueByPath(toObject, ["inlineData"], blobToMldev$2(apiClient, fromInlineData));
...
function functionDeclarationToMldev$2(apiClient, fromObject) {
	...
	if (fromBehavior != null) setValueByPath(toObject, ["behavior"], fromBehavior);
...
function googleSearchToMldev$2(apiClient, fromObject) {
	...
	if (fromTimeRangeFilter != null) setValueByPath(toObject, ["timeRangeFilter"], intervalToMldev$2(apiClient, fromTimeRangeFilter));
	return toObject;
}
...
function toolToMldev$2(apiClient, fromObject) {
	...
	if (fromGoogleSearch != null) setValueByPath(toObject, ["googleSearch"], googleSearchToMldev$2(apiClient, fromGoogleSearch));
	...
	if (getValueByPath(fromObject, ["googleMaps"]) !== void 0) throw new Error("googleMaps parameter is not supported in Gemini API.");
	const fromUrlContext = getValueByPath(fromObject, ["urlContext"]);
	if (fromUrlContext != null) setValueByPath(toObject, ["urlContext"], urlContextToMldev$2());
...
function latLngToMldev$1(apiClient, fromObject) {
	...
	if (fromLatitude != null) setValueByPath(toObject, ["latitude"], fromLatitude);
	const fromLongitude = getValueByPath(fromObject, ["longitude"]);
	if (fromLongitude != null) setValueByPath(toObject, ["longitude"], fromLongitude);
	return toObject;
}
function retrievalConfigToMldev$1(apiClient, fromObject) {
	const toObject = {};
	const fromLatLng = getValueByPath(fromObject, ["latLng"]);
	if (fromLatLng != null) setValueByPath(toObject, ["latLng"], latLngToMldev$1(apiClient, fromLatLng));
	return toObject;
}
function toolConfigToMldev$1(apiClient, fromObject) {
	...
	if (fromRetrievalConfig != null) setValueByPath(toObject, ["retrievalConfig"], retrievalConfigToMldev$1(apiClient, fromRetrievalConfig));
	return toObject;
}
...
function partToVertex$2(apiClient, fromObject) {
	const toObject = {};
	const fromVideoMetadata = getValueByPath(fromObject, ["videoMetadata"]);
	if (fromVideoMetadata != null) setValueByPath(toObject, ["videoMetadata"], videoMetadataToVertex$2(apiClient, fromVideoMetadata));
	const fromThought = getValueByPath(fromObject, ["thought"]);
	if (fromThought != null) setValueByPath(toObject, ["thought"], fromThought);
	const fromInlineData = getValueByPath(fromObject, ["inlineData"]);
	if (fromInlineData != null) setValueByPath(toObject, ["inlineData"], blobToVertex$2(apiClient, fromInlineData));
	const fromCodeExecutionResult = getValueByPath(fromObject, ["codeExecutionResult"]);
	if (fromCodeExecutionResult != null) setValueByPath(toObject, ["codeExecutionResult"], fromCodeExecutionResult);
	const fromExecutableCode = getValueByPath(fromObject, ["executableCode"]);
	if (fromExecutableCode != null) setValueByPath(toObject, ["executableCode"], fromExecutableCode);
...
function googleSearchToVertex$2(apiClient, fromObject) {
	const toObject = {};
	const fromTimeRangeFilter = getValueByPath(fromObject, ["timeRangeFilter"]);
	if (fromTimeRangeFilter != null) setValueByPath(toObject, ["timeRangeFilter"], intervalToVertex$2(apiClient, fromTimeRangeFilter));
	return toObject;
}
...
function apiKeyConfigToVertex$2(apiClient, fromObject) {
	...
	if (fromApiKeyString != null) setValueByPath(toObject, ["apiKeyString"], fromApiKeyString);
	return toObject;
}
function authConfigToVertex$2(apiClient, fromObject) {
	const toObject = {};
	const fromApiKeyConfig = getValueByPath(fromObject, ["apiKeyConfig"]);
	if (fromApiKeyConfig != null) setValueByPath(toObject, ["apiKeyConfig"], apiKeyConfigToVertex$2(apiClient, fromApiKeyConfig));
	const fromAuthType = getValueByPath(fromObject, ["authType"]);
	if (fromAuthType != null) setValueByPath(toObject, ["authType"], fromAuthType);
	const fromGoogleServiceAccountConfig = getValueByPath(fromObject, ["googleServiceAccountConfig"]);
	if (fromGoogleServiceAccountConfig != null) setValueByPath(toObject, ["googleServiceAccountConfig"], fromGoogleServiceAccountConfig);
	const fromHttpBasicAuthConfig = getValueByPath(fromObject, ["httpBasicAuthConfig"]);
	if (fromHttpBasicAuthConfig != null) setValueByPath(toObject, ["httpBasicAuthConfig"], fromHttpBasicAuthConfig);
	const fromOauthConfig = getValueByPath(fromObject, ["oauthConfig"]);
	if (fromOauthConfig != null) setValueByPath(toObject, ["oauthConfig"], fromOauthConfig);
	const fromOidcConfig = getValueByPath(fromObject, ["oidcConfig"]);
	if (fromOidcConfig != null) setValueByPath(toObject, ["oidcConfig"], fromOidcConfig);
	return toObject;
}
function googleMapsToVertex$2(apiClient, fromObject) {
	const toObject = {};
	const fromAuthConfig = getValueByPath(fromObject, ["authConfig"]);
	if (fromAuthConfig != null) setValueByPath(toObject, ["authConfig"], authConfigToVertex$2(apiClient, fromAuthConfig));
	return toObject;
}
function toolToVertex$2(apiClient, fromObject) {
	...
	const fromGoogleSearch = getValueByPath(fromObject, ["googleSearch"]);
	if (fromGoogleSearch != null) setValueByPath(toObject, ["googleSearch"], googleSearchToVertex$2(apiClient, fromGoogleSearch));
	const fromGoogleSearchRetrieval = getValueByPath(fromObject, ["googleSearchRetrieval"]);
	...
	if (fromEnterpriseWebSearch != null) setValueByPath(toObject, ["enterpriseWebSearch"], enterpriseWebSearchToVertex$2());
	const fromGoogleMaps = getValueByPath(fromObject, ["googleMaps"]);
	if (fromGoogleMaps != null) setValueByPath(toObject, ["googleMaps"], googleMapsToVertex$2(apiClient, fromGoogleMaps));
	if (getValueByPath(fromObject, ["urlContext"]) !== void 0) throw new Error("urlContext parameter is not supported in Vertex AI.");
	const fromCodeExecution = getValueByPath(fromObject, ["codeExecution"]);
	if (fromCodeExecution != null) setValueByPath(toObject, ["codeExecution"], fromCodeExecution);
	return toObject;
}
...
function retrievalConfigToVertex$1(apiClient, fromObject) {
	const toObject = {};
	const fromLatLng = getValueByPath(fromObject, ["latLng"]);
	if (fromLatLng != null) setValueByPath(toObject, ["latLng"], latLngToVertex$1(apiClient, fromLatLng));
	return toObject;
}
function toolConfigToVertex$1(apiClient, fromObject) {
	...
	const fromRetrievalConfig = getValueByPath(fromObject, ["retrievalConfig"]);
	if (fromRetrievalConfig != null) setValueByPath(toObject, ["retrievalConfig"], retrievalConfigToVertex$1(apiClient, fromRetrievalConfig));
	return toObject;
}
...
function isValidContent(content) {
	...
	for (const part of content.parts) {
		...
		if (!part.thought && part.text !== void 0 && part.text === "") return false;
	}
	return true;
}
/**
...
function extractCuratedHistory(comprehensiveHistory) {
	...
	while (i < length) if (comprehensiveHistory[i].role === "user") {
		...
		while (i < length && comprehensiveHistory[i].role === "model") {
			...
			if (isValid$1 && !isValidContent(comprehensiveHistory[i])) isValid$1 = false;
			i++;
		}
		if (isValid$1) curatedHistory.push(...modelOutput);
...
function voiceConfigToMldev$1(apiClient, fromObject) {
	...
	if (fromPrebuiltVoiceConfig != null) setValueByPath(toObject, ["prebuiltVoiceConfig"], prebuiltVoiceConfigToMldev$1(apiClient, fromPrebuiltVoiceConfig));
	return toObject;
}
function voiceConfigToVertex$1(apiClient, fromObject) {
	const toObject = {};
	const fromPrebuiltVoiceConfig = getValueByPath(fromObject, ["prebuiltVoiceConfig"]);
	if (fromPrebuiltVoiceConfig != null) setValueByPath(toObject, ["prebuiltVoiceConfig"], prebuiltVoiceConfigToVertex$1(apiClient, fromPrebuiltVoiceConfig));
	return toObject;
}
function speakerVoiceConfigToMldev$1(apiClient, fromObject) {
	...
	if (fromVoiceConfig != null) setValueByPath(toObject, ["voiceConfig"], voiceConfigToMldev$1(apiClient, fromVoiceConfig));
	return toObject;
}
...
function speechConfigToMldev$1(apiClient, fromObject) {
	...
	if (fromMultiSpeakerVoiceConfig != null) setValueByPath(toObject, ["multiSpeakerVoiceConfig"], multiSpeakerVoiceConfigToMldev$1(apiClient, fromMultiSpeakerVoiceConfig));
...
function speechConfigToVertex$1(apiClient, fromObject) {
	const toObject = {};
	const fromVoiceConfig = getValueByPath(fromObject, ["voiceConfig"]);
	if (fromVoiceConfig != null) setValueByPath(toObject, ["voiceConfig"], voiceConfigToVertex$1(apiClient, fromVoiceConfig));
...
function partToMldev$1(apiClient, fromObject) {
	const toObject = {};
	const fromVideoMetadata = getValueByPath(fromObject, ["videoMetadata"]);
	if (fromVideoMetadata != null) setValueByPath(toObject, ["videoMetadata"], videoMetadataToMldev$1(apiClient, fromVideoMetadata));
	const fromThought = getValueByPath(fromObject, ["thought"]);
	if (fromThought != null) setValueByPath(toObject, ["thought"], fromThought);
	const fromInlineData = getValueByPath(fromObject, ["inlineData"]);
	if (fromInlineData != null) setValueByPath(toObject, ["inlineData"], blobToMldev$1(apiClient, fromInlineData));
	const fromCodeExecutionResult = getValueByPath(fromObject, ["codeExecutionResult"]);
	if (fromCodeExecutionResult != null) setValueByPath(toObject, ["codeExecutionResult"], fromCodeExecutionResult);
	const fromExecutableCode = getValueByPath(fromObject, ["executableCode"]);
	if (fromExecutableCode != null) setValueByPath(toObject, ["executableCode"], fromExecutableCode);
...
function partToVertex$1(apiClient, fromObject) {
	const toObject = {};
	const fromVideoMetadata = getValueByPath(fromObject, ["videoMetadata"]);
	if (fromVideoMetadata != null) setValueByPath(toObject, ["videoMetadata"], videoMetadataToVertex$1(apiClient, fromVideoMetadata));
	const fromThought = getValueByPath(fromObject, ["thought"]);
	if (fromThought != null) setValueByPath(toObject, ["thought"], fromThought);
	const fromInlineData = getValueByPath(fromObject, ["inlineData"]);
	if (fromInlineData != null) setValueByPath(toObject, ["inlineData"], blobToVertex$1(apiClient, fromInlineData));
	const fromCodeExecutionResult = getValueByPath(fromObject, ["codeExecutionResult"]);
	if (fromCodeExecutionResult != null) setValueByPath(toObject, ["codeExecutionResult"], fromCodeExecutionResult);
	const fromExecutableCode = getValueByPath(fromObject, ["executableCode"]);
	if (fromExecutableCode != null) setValueByPath(toObject, ["executableCode"], fromExecutableCode);
...
function googleSearchToMldev$1(apiClient, fromObject) {
	const toObject = {};
	const fromTimeRangeFilter = getValueByPath(fromObject, ["timeRangeFilter"]);
	if (fromTimeRangeFilter != null) setValueByPath(toObject, ["timeRangeFilter"], intervalToMldev$1(apiClient, fromTimeRangeFilter));
	return toObject;
}
function googleSearchToVertex$1(apiClient, fromObject) {
	const toObject = {};
	const fromTimeRangeFilter = getValueByPath(fromObject, ["timeRangeFilter"]);
	if (fromTimeRangeFilter != null) setValueByPath(toObject, ["timeRangeFilter"], intervalToVertex$1(apiClient, fromTimeRangeFilter));
	return toObject;
}
...
function authConfigToVertex$1(apiClient, fromObject) {
	const toObject = {};
	const fromApiKeyConfig = getValueByPath(fromObject, ["apiKeyConfig"]);
	if (fromApiKeyConfig != null) setValueByPath(toObject, ["apiKeyConfig"], apiKeyConfigToVertex$1(apiClient, fromApiKeyConfig));
	const fromAuthType = getValueByPath(fromObject, ["authType"]);
	if (fromAuthType != null) setValueByPath(toObject, ["authType"], fromAuthType);
	const fromGoogleServiceAccountConfig = getValueByPath(fromObject, ["googleServiceAccountConfig"]);
	if (fromGoogleServiceAccountConfig != null) setValueByPath(toObject, ["googleServiceAccountConfig"], fromGoogleServiceAccountConfig);
...
function googleMapsToVertex$1(apiClient, fromObject) {
	const toObject = {};
	const fromAuthConfig = getValueByPath(fromObject, ["authConfig"]);
	if (fromAuthConfig != null) setValueByPath(toObject, ["authConfig"], authConfigToVertex$1(apiClient, fromAuthConfig));
	return toObject;
}
...
function toolToMldev$1(apiClient, fromObject) {
	...
	if (getValueByPath(fromObject, ["retrieval"]) !== void 0) throw new Error("retrieval parameter is not supported in Gemini API.");
	const fromGoogleSearch = getValueByPath(fromObject, ["googleSearch"]);
	if (fromGoogleSearch != null) setValueByPath(toObject, ["googleSearch"], googleSearchToMldev$1(apiClient, fromGoogleSearch));
	const fromGoogleSearchRetrieval = getValueByPath(fromObject, ["googleSearchRetrieval"]);
	...
	if (getValueByPath(fromObject, ["googleMaps"]) !== void 0) throw new Error("googleMaps parameter is not supported in Gemini API.");
	const fromUrlContext = getValueByPath(fromObject, ["urlContext"]);
	if (fromUrlContext != null) setValueByPath(toObject, ["urlContext"], urlContextToMldev$1());
	const fromCodeExecution = getValueByPath(fromObject, ["codeExecution"]);
	if (fromCodeExecution != null) setValueByPath(toObject, ["codeExecution"], fromCodeExecution);
	return toObject;
}
function toolToVertex$1(apiClient, fromObject) {
	...
	if (fromRetrieval != null) setValueByPath(toObject, ["retrieval"], fromRetrieval);
	const fromGoogleSearch = getValueByPath(fromObject, ["googleSearch"]);
	if (fromGoogleSearch != null) setValueByPath(toObject, ["googleSearch"], googleSearchToVertex$1(apiClient, fromGoogleSearch));
	const fromGoogleSearchRetrieval = getValueByPath(fromObject, ["googleSearchRetrieval"]);
	...
	const fromEnterpriseWebSearch = getValueByPath(fromObject, ["enterpriseWebSearch"]);
	if (fromEnterpriseWebSearch != null) setValueByPath(toObject, ["enterpriseWebSearch"], enterpriseWebSearchToVertex$1());
	const fromGoogleMaps = getValueByPath(fromObject, ["googleMaps"]);
	if (fromGoogleMaps != null) setValueByPath(toObject, ["googleMaps"], googleMapsToVertex$1(apiClient, fromGoogleMaps));
	if (getValueByPath(fromObject, ["urlContext"]) !== void 0) throw new Error("urlContext parameter is not supported in Vertex AI.");
	const fromCodeExecution = getValueByPath(fromObject, ["codeExecution"]);
	if (fromCodeExecution != null) setValueByPath(toObject, ["codeExecution"], fromCodeExecution);
	return toObject;
...
function proactivityConfigToMldev(apiClient, fromObject) {
	...
	if (fromProactiveAudio != null) setValueByPath(toObject, ["proactiveAudio"], fromProactiveAudio);
	return toObject;
}
...
function liveConnectConfigToMldev(apiClient, fromObject, parentObject) {
	...
	if (parentObject !== void 0 && fromSpeechConfig != null) setValueByPath(parentObject, [
		...
		"generationConfig",
		"speechConfig"
	], speechConfigToMldev$1(apiClient, tLiveSpeechConfig(apiClient, fromSpeechConfig)));
	...
	if (parentObject !== void 0 && fromInputAudioTranscription != null) setValueByPath(parentObject, ["setup", "inputAudioTranscription"], audioTranscriptionConfigToMldev());
	...
	if (parentObject !== void 0 && fromProactivity != null) setValueByPath(parentObject, ["setup", "proactivity"], proactivityConfigToMldev(apiClient, fromProactivity));
	return toObject;
}
function liveConnectConfigToVertex(apiClient, fromObject, parentObject) {
	...
	if (parentObject !== void 0 && fromSpeechConfig != null) setValueByPath(parentObject, [
		...
		"generationConfig",
		"speechConfig"
	], speechConfigToVertex$1(apiClient, tLiveSpeechConfig(apiClient, fromSpeechConfig)));
	const fromEnableAffectiveDialog = getValueByPath(fromObject, ["enableAffectiveDialog"]);
	if (parentObject !== void 0 && fromEnableAffectiveDialog != null) setValueByPath(parentObject, [
		"setup",
		"generationConfig",
	...
	const fromProactivity = getValueByPath(fromObject, ["proactivity"]);
	if (parentObject !== void 0 && fromProactivity != null) setValueByPath(parentObject, ["setup", "proactivity"], proactivityConfigToVertex(apiClient, fromProactivity));
	return toObject;
}
...
function liveSendRealtimeInputParametersToMldev(apiClient, fromObject) {
	...
	if (fromMedia != null) setValueByPath(toObject, ["mediaChunks"], tBlobs(apiClient, fromMedia));
	const fromAudio = getValueByPath(fromObject, ["audio"]);
	if (fromAudio != null) setValueByPath(toObject, ["audio"], tAudioBlob(apiClient, fromAudio));
	...
	if (fromVideo != null) setValueByPath(toObject, ["video"], tImageBlob(apiClient, fromVideo));
	const fromText = getValueByPath(fromObject, ["text"]);
	if (fromText != null) setValueByPath(toObject, ["text"], fromText);
	const fromActivityStart = getValueByPath(fromObject, ["activityStart"]);
	if (fromActivityStart != null) setValueByPath(toObject, ["activityStart"], activityStartToMldev());
	const fromActivityEnd = getValueByPath(fromObject, ["activityEnd"]);
	if (fromActivityEnd != null) setValueByPath(toObject, ["activityEnd"], activityEndToMldev());
	return toObject;
}
function liveSendRealtimeInputParametersToVertex(apiClient, fromObject) {
	...
	const fromMedia = getValueByPath(fromObject, ["media"]);
	if (fromMedia != null) setValueByPath(toObject, ["mediaChunks"], tBlobs(apiClient, fromMedia));
	if (getValueByPath(fromObject, ["audio"]) !== void 0) throw new Error("audio parameter is not supported in Vertex AI.");
	const fromAudioStreamEnd = getValueByPath(fromObject, ["audioStreamEnd"]);
	if (fromAudioStreamEnd != null) setValueByPath(toObject, ["audioStreamEnd"], fromAudioStreamEnd);
	if (getValueByPath(fromObject, ["video"]) !== void 0) throw new Error("video parameter is not supported in Vertex AI.");
	if (getValueByPath(fromObject, ["text"]) !== void 0) throw new Error("text parameter is not supported in Vertex AI.");
	const fromActivityStart = getValueByPath(fromObject, ["activityStart"]);
	if (fromActivityStart != null) setValueByPath(toObject, ["activityStart"], activityStartToVertex());
	const fromActivityEnd = getValueByPath(fromObject, ["activityEnd"]);
	if (fromActivityEnd != null) setValueByPath(toObject, ["activityEnd"], activityEndToVertex());
	return toObject;
}
function weightedPromptToMldev(apiClient, fromObject) {
	...
	if (fromWeight != null) setValueByPath(toObject, ["weight"], fromWeight);
	return toObject;
}
...
function liveMusicGenerationConfigToMldev(apiClient, fromObject) {
	...
	if (fromGuidance != null) setValueByPath(toObject, ["guidance"], fromGuidance);
	const fromBpm = getValueByPath(fromObject, ["bpm"]);
	if (fromBpm != null) setValueByPath(toObject, ["bpm"], fromBpm);
	const fromDensity = getValueByPath(fromObject, ["density"]);
	if (fromDensity != null) setValueByPath(toObject, ["density"], fromDensity);
	const fromBrightness = getValueByPath(fromObject, ["brightness"]);
	if (fromBrightness != null) setValueByPath(toObject, ["brightness"], fromBrightness);
	const fromScale = getValueByPath(fromObject, ["scale"]);
	if (fromScale != null) setValueByPath(toObject, ["scale"], fromScale);
	const fromMuteBass = getValueByPath(fromObject, ["muteBass"]);
	if (fromMuteBass != null) setValueByPath(toObject, ["muteBass"], fromMuteBass);
	const fromMuteDrums = getValueByPath(fromObject, ["muteDrums"]);
	if (fromMuteDrums != null) setValueByPath(toObject, ["muteDrums"], fromMuteDrums);
	const fromOnlyBassAndDrums = getValueByPath(fromObject, ["onlyBassAndDrums"]);
	if (fromOnlyBassAndDrums != null) setValueByPath(toObject, ["onlyBassAndDrums"], fromOnlyBassAndDrums);
	const fromMusicGenerationMode = getValueByPath(fromObject, ["musicGenerationMode"]);
	if (fromMusicGenerationMode != null) setValueByPath(toObject, ["musicGenerationMode"], fromMusicGenerationMode);
	return toObject;
}
function liveMusicSetConfigParametersToMldev(apiClient, fromObject) {
	...
	if (fromMusicGenerationConfig != null) setValueByPath(toObject, ["musicGenerationConfig"], liveMusicGenerationConfigToMldev(apiClient, fromMusicGenerationConfig));
	return toObject;
}
...
function liveMusicClientMessageToMldev(apiClient, fromObject) {
	...
	if (fromSetup != null) setValueByPath(toObject, ["setup"], liveMusicClientSetupToMldev(apiClient, fromSetup));
	const fromClientContent = getValueByPath(fromObject, ["clientContent"]);
	if (fromClientContent != null) setValueByPath(toObject, ["clientContent"], liveMusicClientContentToMldev(apiClient, fromClientContent));
	const fromMusicGenerationConfig = getValueByPath(fromObject, ["musicGenerationConfig"]);
	if (fromMusicGenerationConfig != null) setValueByPath(toObject, ["musicGenerationConfig"], liveMusicGenerationConfigToMldev(apiClient, fromMusicGenerationConfig));
	const fromPlaybackControl = getValueByPath(fromObject, ["playbackControl"]);
	if (fromPlaybackControl != null) setValueByPath(toObject, ["playbackControl"], fromPlaybackControl);
	return toObject;
}
...
function partFromMldev$1(apiClient, fromObject) {
	const toObject = {};
	const fromVideoMetadata = getValueByPath(fromObject, ["videoMetadata"]);
	if (fromVideoMetadata != null) setValueByPath(toObject, ["videoMetadata"], videoMetadataFromMldev$1(apiClient, fromVideoMetadata));
	const fromThought = getValueByPath(fromObject, ["thought"]);
	if (fromThought != null) setValueByPath(toObject, ["thought"], fromThought);
	const fromInlineData = getValueByPath(fromObject, ["inlineData"]);
	if (fromInlineData != null) setValueByPath(toObject, ["inlineData"], blobFromMldev$1(apiClient, fromInlineData));
	const fromCodeExecutionResult = getValueByPath(fromObject, ["codeExecutionResult"]);
	if (fromCodeExecutionResult != null) setValueByPath(toObject, ["codeExecutionResult"], fromCodeExecutionResult);
	const fromExecutableCode = getValueByPath(fromObject, ["executableCode"]);
	if (fromExecutableCode != null) setValueByPath(toObject, ["executableCode"], fromExecutableCode);
...
function partFromVertex$1(apiClient, fromObject) {
	const toObject = {};
	const fromVideoMetadata = getValueByPath(fromObject, ["videoMetadata"]);
	if (fromVideoMetadata != null) setValueByPath(toObject, ["videoMetadata"], videoMetadataFromVertex$1(apiClient, fromVideoMetadata));
	const fromThought = getValueByPath(fromObject, ["thought"]);
	if (fromThought != null) setValueByPath(toObject, ["thought"], fromThought);
	const fromInlineData = getValueByPath(fromObject, ["inlineData"]);
	if (fromInlineData != null) setValueByPath(toObject, ["inlineData"], blobFromVertex$1(apiClient, fromInlineData));
	const fromCodeExecutionResult = getValueByPath(fromObject, ["codeExecutionResult"]);
	if (fromCodeExecutionResult != null) setValueByPath(toObject, ["codeExecutionResult"], fromCodeExecutionResult);
	const fromExecutableCode = getValueByPath(fromObject, ["executableCode"]);
	if (fromExecutableCode != null) setValueByPath(toObject, ["executableCode"], fromExecutableCode);
...
function urlMetadataFromMldev$1(apiClient, fromObject) {
	...
	if (fromRetrievedUrl != null) setValueByPath(toObject, ["retrievedUrl"], fromRetrievedUrl);
	const fromUrlRetrievalStatus = getValueByPath(fromObject, ["urlRetrievalStatus"]);
	if (fromUrlRetrievalStatus != null) setValueByPath(toObject, ["urlRetrievalStatus"], fromUrlRetrievalStatus);
	return toObject;
}
...
function liveServerContentFromMldev(apiClient, fromObject) {
	...
	if (fromUrlContextMetadata != null) setValueByPath(toObject, ["urlContextMetadata"], urlContextMetadataFromMldev$1(apiClient, fromUrlContextMetadata));
	return toObject;
}
...
function liveMusicSourceMetadataFromMldev(apiClient, fromObject) {
	const toObject = {};
	const fromClientContent = getValueByPath(fromObject, ["clientContent"]);
	if (fromClientContent != null) setValueByPath(toObject, ["clientContent"], liveMusicClientContentFromMldev(apiClient, fromClientContent));
	const fromMusicGenerationConfig = getValueByPath(fromObject, ["musicGenerationConfig"]);
	if (fromMusicGenerationConfig != null) setValueByPath(toObject, ["musicGenerationConfig"], liveMusicGenerationConfigFromMldev(apiClient, fromMusicGenerationConfig));
	return toObject;
}
function audioChunkFromMldev(apiClient, fromObject) {
	...
	if (fromSourceMetadata != null) setValueByPath(toObject, ["sourceMetadata"], liveMusicSourceMetadataFromMldev(apiClient, fromSourceMetadata));
	return toObject;
}
...
function liveMusicFilteredPromptFromMldev(apiClient, fromObject) {
	...
	if (fromFilteredReason != null) setValueByPath(toObject, ["filteredReason"], fromFilteredReason);
	return toObject;
}
function liveMusicServerMessageFromMldev(apiClient, fromObject) {
	const toObject = {};
	const fromSetupComplete = getValueByPath(fromObject, ["setupComplete"]);
	if (fromSetupComplete != null) setValueByPath(toObject, ["setupComplete"], liveMusicServerSetupCompleteFromMldev());
	const fromServerContent = getValueByPath(fromObject, ["serverContent"]);
	if (fromServerContent != null) setValueByPath(toObject, ["serverContent"], liveMusicServerContentFromMldev(apiClient, fromServerContent));
	const fromFilteredPrompt = getValueByPath(fromObject, ["filteredPrompt"]);
	if (fromFilteredPrompt != null) setValueByPath(toObject, ["filteredPrompt"], liveMusicFilteredPromptFromMldev(apiClient, fromFilteredPrompt));
	return toObject;
}
/**
* @license
...
function partToMldev(apiClient, fromObject) {
	const toObject = {};
	const fromVideoMetadata = getValueByPath(fromObject, ["videoMetadata"]);
	if (fromVideoMetadata != null) setValueByPath(toObject, ["videoMetadata"], videoMetadataToMldev(apiClient, fromVideoMetadata));
	const fromThought = getValueByPath(fromObject, ["thought"]);
	if (fromThought != null) setValueByPath(toObject, ["thought"], fromThought);
	const fromInlineData = getValueByPath(fromObject, ["inlineData"]);
	if (fromInlineData != null) setValueByPath(toObject, ["inlineData"], blobToMldev(apiClient, fromInlineData));
	const fromCodeExecutionResult = getValueByPath(fromObject, ["codeExecutionResult"]);
	if (fromCodeExecutionResult != null) setValueByPath(toObject, ["codeExecutionResult"], fromCodeExecutionResult);
	const fromExecutableCode = getValueByPath(fromObject, ["executableCode"]);
	if (fromExecutableCode != null) setValueByPath(toObject, ["executableCode"], fromExecutableCode);
...
function googleSearchToMldev(apiClient, fromObject) {
	const toObject = {};
	const fromTimeRangeFilter = getValueByPath(fromObject, ["timeRangeFilter"]);
	if (fromTimeRangeFilter != null) setValueByPath(toObject, ["timeRangeFilter"], intervalToMldev(apiClient, fromTimeRangeFilter));
	return toObject;
}
...
function toolToMldev(apiClient, fromObject) {
	...
	if (getValueByPath(fromObject, ["retrieval"]) !== void 0) throw new Error("retrieval parameter is not supported in Gemini API.");
	const fromGoogleSearch = getValueByPath(fromObject, ["googleSearch"]);
	if (fromGoogleSearch != null) setValueByPath(toObject, ["googleSearch"], googleSearchToMldev(apiClient, fromGoogleSearch));
	const fromGoogleSearchRetrieval = getValueByPath(fromObject, ["googleSearchRetrieval"]);
	...
	if (getValueByPath(fromObject, ["googleMaps"]) !== void 0) throw new Error("googleMaps parameter is not supported in Gemini API.");
	const fromUrlContext = getValueByPath(fromObject, ["urlContext"]);
	if (fromUrlContext != null) setValueByPath(toObject, ["urlContext"], urlContextToMldev());
	const fromCodeExecution = getValueByPath(fromObject, ["codeExecution"]);
	if (fromCodeExecution != null) setValueByPath(toObject, ["codeExecution"], fromCodeExecution);
	return toObject;
}
...
function retrievalConfigToMldev(apiClient, fromObject) {
	const toObject = {};
	const fromLatLng = getValueByPath(fromObject, ["latLng"]);
	if (fromLatLng != null) setValueByPath(toObject, ["latLng"], latLngToMldev(apiClient, fromLatLng));
	return toObject;
}
function toolConfigToMldev(apiClient, fromObject) {
	...
	const fromRetrievalConfig = getValueByPath(fromObject, ["retrievalConfig"]);
	if (fromRetrievalConfig != null) setValueByPath(toObject, ["retrievalConfig"], retrievalConfigToMldev(apiClient, fromRetrievalConfig));
	return toObject;
}
...
function speechConfigToMldev(apiClient, fromObject) {
	...
	if (fromVoiceConfig != null) setValueByPath(toObject, ["voiceConfig"], voiceConfigToMldev(apiClient, fromVoiceConfig));
	const fromMultiSpeakerVoiceConfig = getValueByPath(fromObject, ["multiSpeakerVoiceConfig"]);
	if (fromMultiSpeakerVoiceConfig != null) setValueByPath(toObject, ["multiSpeakerVoiceConfig"], multiSpeakerVoiceConfigToMldev(apiClient, fromMultiSpeakerVoiceConfig));
	const fromLanguageCode = getValueByPath(fromObject, ["languageCode"]);
	if (fromLanguageCode != null) setValueByPath(toObject, ["languageCode"], fromLanguageCode);
	return toObject;
}
...
function generateContentConfigToMldev(apiClient, fromObject, parentObject) {
	...
	if (fromResponseSchema != null) setValueByPath(toObject, ["responseSchema"], tSchema(apiClient, fromResponseSchema));
...
function listModelsParametersToMldev(apiClient, fromObject) {
	const toObject = {};
	const fromConfig = getValueByPath(fromObject, ["config"]);
	if (fromConfig != null) setValueByPath(toObject, ["config"], listModelsConfigToMldev(apiClient, fromConfig, toObject));
	return toObject;
}
...
function updateModelParametersToMldev(apiClient, fromObject) {
	...
	if (fromModel != null) setValueByPath(toObject, ["_url", "name"], tModel(apiClient, fromModel));
	const fromConfig = getValueByPath(fromObject, ["config"]);
	if (fromConfig != null) setValueByPath(toObject, ["config"], updateModelConfigToMldev(apiClient, fromConfig, toObject));
	return toObject;
}
...
function partToVertex(apiClient, fromObject) {
	const toObject = {};
	const fromVideoMetadata = getValueByPath(fromObject, ["videoMetadata"]);
	if (fromVideoMetadata != null) setValueByPath(toObject, ["videoMetadata"], videoMetadataToVertex(apiClient, fromVideoMetadata));
	const fromThought = getValueByPath(fromObject, ["thought"]);
	if (fromThought != null) setValueByPath(toObject, ["thought"], fromThought);
	const fromInlineData = getValueByPath(fromObject, ["inlineData"]);
	if (fromInlineData != null) setValueByPath(toObject, ["inlineData"], blobToVertex(apiClient, fromInlineData));
	const fromCodeExecutionResult = getValueByPath(fromObject, ["codeExecutionResult"]);
	if (fromCodeExecutionResult != null) setValueByPath(toObject, ["codeExecutionResult"], fromCodeExecutionResult);
	const fromExecutableCode = getValueByPath(fromObject, ["executableCode"]);
	if (fromExecutableCode != null) setValueByPath(toObject, ["executableCode"], fromExecutableCode);
...
function googleSearchToVertex(apiClient, fromObject) {
	const toObject = {};
	const fromTimeRangeFilter = getValueByPath(fromObject, ["timeRangeFilter"]);
	if (fromTimeRangeFilter != null) setValueByPath(toObject, ["timeRangeFilter"], intervalToVertex(apiClient, fromTimeRangeFilter));
	return toObject;
}
...
function authConfigToVertex(apiClient, fromObject) {
	const toObject = {};
	const fromApiKeyConfig = getValueByPath(fromObject, ["apiKeyConfig"]);
	if (fromApiKeyConfig != null) setValueByPath(toObject, ["apiKeyConfig"], apiKeyConfigToVertex(apiClient, fromApiKeyConfig));
	const fromAuthType = getValueByPath(fromObject, ["authType"]);
	if (fromAuthType != null) setValueByPath(toObject, ["authType"], fromAuthType);
	const fromGoogleServiceAccountConfig = getValueByPath(fromObject, ["googleServiceAccountConfig"]);
	if (fromGoogleServiceAccountConfig != null) setValueByPath(toObject, ["googleServiceAccountConfig"], fromGoogleServiceAccountConfig);
...
function googleMapsToVertex(apiClient, fromObject) {
	const toObject = {};
	const fromAuthConfig = getValueByPath(fromObject, ["authConfig"]);
	if (fromAuthConfig != null) setValueByPath(toObject, ["authConfig"], authConfigToVertex(apiClient, fromAuthConfig));
	return toObject;
}
function toolToVertex(apiClient, fromObject) {
	...
	if (fromRetrieval != null) setValueByPath(toObject, ["retrieval"], fromRetrieval);
	const fromGoogleSearch = getValueByPath(fromObject, ["googleSearch"]);
	if (fromGoogleSearch != null) setValueByPath(toObject, ["googleSearch"], googleSearchToVertex(apiClient, fromGoogleSearch));
	const fromGoogleSearchRetrieval = getValueByPath(fromObject, ["googleSearchRetrieval"]);
	...
	const fromEnterpriseWebSearch = getValueByPath(fromObject, ["enterpriseWebSearch"]);
	if (fromEnterpriseWebSearch != null) setValueByPath(toObject, ["enterpriseWebSearch"], enterpriseWebSearchToVertex());
	const fromGoogleMaps = getValueByPath(fromObject, ["googleMaps"]);
	if (fromGoogleMaps != null) setValueByPath(toObject, ["googleMaps"], googleMapsToVertex(apiClient, fromGoogleMaps));
	if (getValueByPath(fromObject, ["urlContext"]) !== void 0) throw new Error("urlContext parameter is not supported in Vertex AI.");
	const fromCodeExecution = getValueByPath(fromObject, ["codeExecution"]);
	if (fromCodeExecution != null) setValueByPath(toObject, ["codeExecution"], fromCodeExecution);
	return toObject;
...
function retrievalConfigToVertex(apiClient, fromObject) {
	const toObject = {};
	const fromLatLng = getValueByPath(fromObject, ["latLng"]);
	if (fromLatLng != null) setValueByPath(toObject, ["latLng"], latLngToVertex(apiClient, fromLatLng));
	return toObject;
}
function toolConfigToVertex(apiClient, fromObject) {
	...
	const fromRetrievalConfig = getValueByPath(fromObject, ["retrievalConfig"]);
	if (fromRetrievalConfig != null) setValueByPath(toObject, ["retrievalConfig"], retrievalConfigToVertex(apiClient, fromRetrievalConfig));
	return toObject;
}
...
function styleReferenceConfigToVertex(apiClient, fromObject) {
	...
	if (fromStyleDescription != null) setValueByPath(toObject, ["styleDescription"], fromStyleDescription);
	return toObject;
}
function subjectReferenceConfigToVertex(apiClient, fromObject) {
	const toObject = {};
	const fromSubjectType = getValueByPath(fromObject, ["subjectType"]);
	if (fromSubjectType != null) setValueByPath(toObject, ["subjectType"], fromSubjectType);
	const fromSubjectDescription = getValueByPath(fromObject, ["subjectDescription"]);
	if (fromSubjectDescription != null) setValueByPath(toObject, ["subjectDescription"], fromSubjectDescription);
	return toObject;
}
function referenceImageAPIInternalToVertex(apiClient, fromObject) {
	...
	if (fromReferenceImage != null) setValueByPath(toObject, ["referenceImage"], imageToVertex(apiClient, fromReferenceImage));
	...
	if (fromMaskImageConfig != null) setValueByPath(toObject, ["maskImageConfig"], maskReferenceConfigToVertex(apiClient, fromMaskImageConfig));
	const fromControlImageConfig = getValueByPath(fromObject, ["controlImageConfig"]);
	if (fromControlImageConfig != null) setValueByPath(toObject, ["controlImageConfig"], controlReferenceConfigToVertex(apiClient, fromControlImageConfig));
	const fromStyleImageConfig = getValueByPath(fromObject, ["styleImageConfig"]);
	if (fromStyleImageConfig != null) setValueByPath(toObject, ["styleImageConfig"], styleReferenceConfigToVertex(apiClient, fromStyleImageConfig));
	const fromSubjectImageConfig = getValueByPath(fromObject, ["subjectImageConfig"]);
	if (fromSubjectImageConfig != null) setValueByPath(toObject, ["subjectImageConfig"], subjectReferenceConfigToVertex(apiClient, fromSubjectImageConfig));
	return toObject;
}
...
function editImageParametersInternalToVertex(apiClient, fromObject) {
	...
	const fromConfig = getValueByPath(fromObject, ["config"]);
	if (fromConfig != null) setValueByPath(toObject, ["config"], editImageConfigToVertex(apiClient, fromConfig, toObject));
	return toObject;
}
...
function upscaleImageAPIParametersInternalToVertex(apiClient, fromObject) {
	...
	const fromConfig = getValueByPath(fromObject, ["config"]);
	if (fromConfig != null) setValueByPath(toObject, ["config"], upscaleImageAPIConfigInternalToVertex(apiClient, fromConfig, toObject));
	return toObject;
}
...
function listModelsParametersToVertex(apiClient, fromObject) {
	const toObject = {};
	const fromConfig = getValueByPath(fromObject, ["config"]);
	if (fromConfig != null) setValueByPath(toObject, ["config"], listModelsConfigToVertex(apiClient, fromConfig, toObject));
	return toObject;
}
...
function updateModelParametersToVertex(apiClient, fromObject) {
	...
	if (fromModel != null) setValueByPath(toObject, ["_url", "model"], tModel(apiClient, fromModel));
	const fromConfig = getValueByPath(fromObject, ["config"]);
	if (fromConfig != null) setValueByPath(toObject, ["config"], updateModelConfigToVertex(apiClient, fromConfig, toObject));
	return toObject;
}
...
function partFromMldev(apiClient, fromObject) {
	const toObject = {};
	const fromVideoMetadata = getValueByPath(fromObject, ["videoMetadata"]);
	if (fromVideoMetadata != null) setValueByPath(toObject, ["videoMetadata"], videoMetadataFromMldev(apiClient, fromVideoMetadata));
	const fromThought = getValueByPath(fromObject, ["thought"]);
	if (fromThought != null) setValueByPath(toObject, ["thought"], fromThought);
	const fromInlineData = getValueByPath(fromObject, ["inlineData"]);
	if (fromInlineData != null) setValueByPath(toObject, ["inlineData"], blobFromMldev(apiClient, fromInlineData));
	const fromCodeExecutionResult = getValueByPath(fromObject, ["codeExecutionResult"]);
	if (fromCodeExecutionResult != null) setValueByPath(toObject, ["codeExecutionResult"], fromCodeExecutionResult);
	const fromExecutableCode = getValueByPath(fromObject, ["executableCode"]);
	if (fromExecutableCode != null) setValueByPath(toObject, ["executableCode"], fromExecutableCode);
...
function candidateFromMldev(apiClient, fromObject) {
	...
	const fromUrlContextMetadata = getValueByPath(fromObject, ["urlContextMetadata"]);
	if (fromUrlContextMetadata != null) setValueByPath(toObject, ["urlContextMetadata"], urlContextMetadataFromMldev(apiClient, fromUrlContextMetadata));
...
function partFromVertex(apiClient, fromObject) {
	const toObject = {};
	const fromVideoMetadata = getValueByPath(fromObject, ["videoMetadata"]);
	if (fromVideoMetadata != null) setValueByPath(toObject, ["videoMetadata"], videoMetadataFromVertex(apiClient, fromVideoMetadata));
	const fromThought = getValueByPath(fromObject, ["thought"]);
	if (fromThought != null) setValueByPath(toObject, ["thought"], fromThought);
	const fromInlineData = getValueByPath(fromObject, ["inlineData"]);
	if (fromInlineData != null) setValueByPath(toObject, ["inlineData"], blobFromVertex(apiClient, fromInlineData));
	const fromCodeExecutionResult = getValueByPath(fromObject, ["codeExecutionResult"]);
	if (fromCodeExecutionResult != null) setValueByPath(toObject, ["codeExecutionResult"], fromCodeExecutionResult);
	const fromExecutableCode = getValueByPath(fromObject, ["executableCode"]);
	if (fromExecutableCode != null) setValueByPath(toObject, ["executableCode"], fromExecutableCode);
...
function checkpointFromVertex(apiClient, fromObject) {
	...
	if (fromCheckpointId != null) setValueByPath(toObject, ["checkpointId"], fromCheckpointId);
	const fromEpoch = getValueByPath(fromObject, ["epoch"]);
	if (fromEpoch != null) setValueByPath(toObject, ["epoch"], fromEpoch);
	const fromStep = getValueByPath(fromObject, ["step"]);
	if (fromStep != null) setValueByPath(toObject, ["step"], fromStep);
	return toObject;
}
			...
			try {
				...
				while (true) {
					...
					try {
						...
						const error = e;
						if (error.name === "ClientError" || error.name === "ServerError") throw e;
					}
					buffer += chunkString;
...
var LiveMusic = class {
	...
	*/
	async connect(params) {
		...
		const setup = liveMusicClientSetupToMldev(this.apiClient, { model });
...
var LiveMusicSession = class {
	...
	*/
	...
	sendPlaybackControl(playbackControl) {
		const clientMessage = liveMusicClientMessageToMldev(this.apiClient, { playbackControl });
		this.conn.send(JSON.stringify(clientMessage));
	}
	/**
...
var Session = class {
	...
	*/
	sendRealtimeInput(params) {
		let clientMessage = {};
		if (this.apiClient.isVertexAI()) clientMessage = { "realtimeInput": liveSendRealtimeInputParametersToVertex(this.apiClient, params) };
		else clientMessage = { "realtimeInput": liveSendRealtimeInputParametersToMldev(this.apiClient, params) };
		this.conn.send(JSON.stringify(clientMessage));
	}
	/**
...
var Models = class extends BaseModule {
	constructor(apiClient) {
		...
		*/
		this.generateContent = async (params) => {
			...
			if (params.config && params.config.tools && hasMcpToolUsage(params.config.tools)) {
				if (!params.config.httpOptions) params.config.httpOptions = {};
				if (!params.config.httpOptions.headers) params.config.httpOptions.headers = this.apiClient.getDefaultHeaders();
				setMcpUsageHeader(params.config.httpOptions.headers);
			}
			if (!hasMcpClientTools(params) || shouldDisableAfc(params.config)) return await this.generateContentInternal(params);
		...
		*/
		...
		this.list = async (params) => {
			var _a;
			const defaultConfig = { queryBase: true };
			const actualConfig = Object.assign(Object.assign({}, defaultConfig), params === null || params === void 0 ? void 0 : params.config);
			const actualParams = { config: actualConfig };
			if (this.apiClient.isVertexAI()) {
		...
		return function(models, afcTools, params$1) {
			...
			return __asyncGenerator(this, arguments, function* () {
				...
				while (remoteCallCount < maxRemoteCalls) {
					...
					const transformedParams = yield __await(models.transformCallableTools(params$1));
					...
					if (functionResponses.length > 0) {
						...
						const updatedContents = tContents(models.apiClient, params$1.contents).concat(newContents);
						params$1.contents = updatedContents;
					} else break;
				}
			});
...
function listTuningJobsParametersToMldev(apiClient, fromObject) {
	const toObject = {};
	const fromConfig = getValueByPath(fromObject, ["config"]);
	if (fromConfig != null) setValueByPath(toObject, ["config"], listTuningJobsConfigToMldev(apiClient, fromConfig, toObject));
	return toObject;
}
function tuningExampleToMldev(apiClient, fromObject) {
	const toObject = {};
	const fromTextInput = getValueByPath(fromObject, ["textInput"]);
	if (fromTextInput != null) setValueByPath(toObject, ["textInput"], fromTextInput);
...
function createTuningJobParametersToMldev(apiClient, fromObject) {
	...
	if (fromTrainingDataset != null) setValueByPath(toObject, ["tuningTask", "trainingData"], tuningDatasetToMldev(apiClient, fromTrainingDataset));
	const fromConfig = getValueByPath(fromObject, ["config"]);
	if (fromConfig != null) setValueByPath(toObject, ["config"], createTuningJobConfigToMldev(apiClient, fromConfig, toObject));
	return toObject;
}
...
function listTuningJobsParametersToVertex(apiClient, fromObject) {
	const toObject = {};
	const fromConfig = getValueByPath(fromObject, ["config"]);
	if (fromConfig != null) setValueByPath(toObject, ["config"], listTuningJobsConfigToVertex(apiClient, fromConfig, toObject));
	return toObject;
}
...
function createTuningJobConfigToVertex(apiClient, fromObject, parentObject) {
	...
	if (parentObject !== void 0 && fromValidationDataset != null) setValueByPath(parentObject, ["supervisedTuningSpec"], tuningValidationDatasetToVertex(apiClient, fromValidationDataset));
	const fromTunedModelDisplayName = getValueByPath(fromObject, ["tunedModelDisplayName"]);
...
function createTuningJobParametersToVertex(apiClient, fromObject) {
	...
	if (fromBaseModel != null) setValueByPath(toObject, ["baseModel"], fromBaseModel);
	const fromTrainingDataset = getValueByPath(fromObject, ["trainingDataset"]);
	if (fromTrainingDataset != null) setValueByPath(toObject, ["supervisedTuningSpec", "trainingDatasetUri"], tuningDatasetToVertex(apiClient, fromTrainingDataset, toObject));
	const fromConfig = getValueByPath(fromObject, ["config"]);
	if (fromConfig != null) setValueByPath(toObject, ["config"], createTuningJobConfigToVertex(apiClient, fromConfig, toObject));
	return toObject;
}
...
function tuningJobFromMldev(apiClient, fromObject) {
	...
	if (fromName != null) setValueByPath(toObject, ["name"], fromName);
	const fromState = getValueByPath(fromObject, ["state"]);
	if (fromState != null) setValueByPath(toObject, ["state"], tTuningJobStatus(apiClient, fromState));
	const fromCreateTime = getValueByPath(fromObject, ["createTime"]);
	if (fromCreateTime != null) setValueByPath(toObject, ["createTime"], fromCreateTime);
	...
	if (fromTunedModel != null) setValueByPath(toObject, ["tunedModel"], tunedModelFromMldev(apiClient, fromTunedModel));
...
function tuningJobFromVertex(apiClient, fromObject) {
	...
	if (fromTunedModel != null) setValueByPath(toObject, ["tunedModel"], tunedModelFromVertex(apiClient, fromTunedModel));
...
var GoogleGenAI = class {
	constructor(options) {
		...
		const baseUrl = getBaseUrl(options, void 0, void 0);
